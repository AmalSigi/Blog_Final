...
export class SharedDynamicComponent{
    ...
    public extPic:boolean=false;
        ...
        path: string = '';
        constructor(private advertisementService: AdvertisementService,private http:HttpClient,private readonly mediaApi:MediaApi,private readonly siteApi:siteSettingApi) {}
      ...
      this.linkUpload=!this.linkUpload;
        ...
        public unshowBox() {
          ...
          public uploadImg() {
            ...
            this.advertisementService.addNewMedia(this.imgFormat,formData)
            .subscribe
              ({
                next: (response) => {
          ...
          public uploadExistingImg() {
            ...
            this.advertisementService.addExistingMedia({mediaId:this.selectedImageId})
            .subscribe
              ({
                next: (response) => {
          ...
          public uploadVid() {
            ...
            this.advertisementService.addNewMedia(this.vidFormat,formData)
            .subscribe
              ({
                next: (response) => {
                  this.videoAdv();
          ...
          public uploadExistingVid() {
            ...
            this.advertisementService.addExistingMedia({mediaId:this.selectedVideoId})
            .subscribe
              ({
                next: (response) => {
                  console.log(response)
          ...
          public uploadExistingLink() {
            ...
            this.http.post(`http://192.168.29.97:5296/api/Theme/dynamicList/existingMedia`,{mediaId:this.selectedLinkId})
            .subscribe
              ({
                next: (response) => {
        ...
        //   console.log(formData)
            this.advertisementService.addLink(formData)
            .subscribe
              ({
                next: (response) => {
        this.externalAdv();
